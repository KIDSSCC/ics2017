...
opcode_entry opcode_table [512] = {
  ...
  /* 0x68 */	IDEX(r, push), EMPTY, IDEXW(push_SI, push, 1), IDEX(I_E2G, imul3),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(mov_E2G, movzx, 1), IDEXW(mov_E2G, movzx, 1),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEXW(mov_E2G, movsx, 1), IDEXW(mov_E2G, movsx, 1),
